...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const fullPageInstance = new fullpage('#fullpage', {
        ...
        // Позволяет кликам по ссылкам с data-menuanchor переключать секции
        menu: '#nav',

        // ------ Анимация прокрутки ------
        scrollingSpeed: 900,           // Скорость прокрутки в миллисекундах

        // ------ Эффект перехода ------
        // Доступные: 'linear', 'easeOutBack', 'easeInOutCubic' и др.
        easingcss3: 'ease',

        // ------ Автоматическая прокрутка ------
        autoScrolling: true,           // Включить автоматическую прокрутку
        scrollHorizontally: false,     // Отключить горизонтальную прокрутку

        // ------ Адаптивность ------
        // Отключаем fullPage.js на маленьких экранах для лучшего UX
        responsiveWidth: 0,            // 0 = не отключать
        responsiveHeight: 0,           // 0 = не отключать

        // ------ Навигация ------
        navigation: false,             // Боковые точки навигации (отключены)

        // ------ Поведение при скролле ------
        scrollOverflow: true,          // Разрешить скролл внутри секции если контент не помещается

        // ------ Тачпад и мышь ------
        normalScrollElements: '.swiper-wrapper', // Элементы с обычным скроллом

        // ------ Лицензионный ключ (для бесплатного использования) ------
        licenseKey: 'gplv3-license',

        // ------ Callbacks (обратные вызовы) ------

        /**
         * Вызывается при загрузке секции
         * @param {object} origin - Предыдущая секция (null при первой загрузке)
         * @param {object} destination - Текущая секция
         * @param {string} direction - Направление прокрутки ('up' или 'down')
         */
        afterLoad: function (origin, destination, direction) {
            // Получаем якорь текущей секции
        ...
        /**
         * Вызывается при выходе из секции
         */
        onLeave: function (origin, destination, direction) {
            // Можно добавить анимации при уходе с секции
        }
    });
